...
CI runs the first five. The last two are the visual proof and take a minute. The agent guard tests exercise
the Codex hook commands and their file boundaries. `selftest` runs the whole
